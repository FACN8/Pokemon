    ...
    <section className="choicePage">
      <div name="LeftChoice" className="choice">
        <form>
            ...
            <input name="name1" value={n1} type='text' onChange={(event)=> { sn1(event.target.value)}}/>
        ...
        <div>
            ...
            <h2 align="left"><b>Hight: </b>{pokemon1.height}</h2>  
            <h2 align="left"><b>Weight: </b>{pokemon1.weight}</h2> 
            <h2 align="left"><b>Ability 1: </b>{pokemon1.abilities[0].ability.name}</h2>  
            <h2 align="left"><b>Ability 2: </b>{pokemon1.abilities[1].ability.name}</h2> 
        </div>
    </div>
    <div name="RightChoice" className="choice">
      <form>
      <label htmlFor="name2">Trainer's Name:</label>
            <input name="name2" value={n2} type='text' onChange={(event)=>{ sn2(event.target.value)}}/>
      ...
      <div>
            ...
            <h2 align="left"><b>Hight: </b>{pokemon2.height}</h2>  
            <h2 align="left"><b>Weight: </b>{pokemon2.weight}</h2> 
            <h2 align="left"><b>Ability 1: </b>{pokemon2.abilities[0].ability.name}</h2>  
            <h2 align="left"><b>Ability 2: </b>{pokemon2.abilities[1].ability.name}</h2> 
        </div>
    </div>
