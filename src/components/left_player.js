  ...
  return (
    <section className="player">
      ...
      <div id="leftPlayer">
        ...
        <h1>Mahmod</h1>
        <ul className="moves">
          <li>1<button onClick={()=>{if(turn==1) setMove({power: moves[0].power})}}>{moves[0].name}</button>
          </li>
          <li>2 <button onClick={()=>{if(turn==1) setMove({power: moves[1].power})}}>{moves[1].name}</button>
          </li>
          <li>3 <button onClick={()=>{if(turn==1) setMove({power: moves[2].power})}}>{moves[2].name}</button>
          </li>
          <li>4 <button onClick={()=>{if(turn==1) setMove({power: moves[3].power})}}>{moves[3].name}</button>
          </li>
        </ul>
